...
# SRCS = ft_strlcpy.c
SRCS_B = ft_lstadd_back_bonus.c ft_lstadd_front_bonus.c ft_lstnew_bonus.c ft_lstsize_bonus.c  ft_lstlast_bonus.c ft_lstdelone_bonus.c ft_lstclear_bonus.c
